...
*/
    ...
    public CommonResult<DashboardCountResponse> dashboardPatientCount (DashboardRequest request) {
    ...
    public CommonResult<DashboardAmountResponse> dashboardPatientAmount (DashboardRequest request) {
    ...
    public CommonResult<DashboardSurgeryCountResponse> dashboardSurgeryCount (DashboardRequest request) {
    ...
    public CommonResult<DashboardWardRateResponse> dashboardWardRate (DashboardRequest request) {
